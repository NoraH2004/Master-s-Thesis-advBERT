...
\begin{figure}
    ...
    \caption{Demonstration of substantial syntactic information found in BERT attention heads ~\protect\cite{clark2019does}.}
...
\begin{figure}
    ...
    \caption{Representation of BERTbase uncased attention heads for the original sentence "It's wonderful for computer gaming."\footnote{\url{https://huggingface.co/exbert/}}.}
...
\minipage{0.32\textwidth}
  ...
  \caption{Leet Speak Method: "It's w0nd3rfu1 for computer gaming."}\label{fig:attention_leet}
\endminipage\hfill
\minipage{0.32\textwidth}
  \includegraphics[width=\linewidth]{img/attention_typo.png}
  \caption{Misspelling Method:"It's wonderfull for computer gaming."}\label{fig:attention_typo}
\endminipage\hfill
\minipage{0.32\textwidth}%
  \includegraphics[width=\linewidth]{img/attention_punct.png}
  \caption{Punctuation Method: "It's wonderful, for computer gaming."}\label{fig:attention_punct}
\endminipage
\end{figure}
